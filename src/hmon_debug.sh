...
libtool --mode=execute gdb --eval-command "handle SIG34 pass noprint nostop" --eval-command "handle SIGINT pass" --args ./hmonitor --input ../example/example_monitor -f 1
