...
extern char * monitor_performance_plugin_dir;

/**
 * Check and set the directory where to find plugins
 **/
void check_monitor_performance_plugin_dir();
 ...
 **/
struct monitor_perf_lib * monitor_load_perf_lib(const char * name);
